...
Use [DESIGN.md](https://github.com/deepelementlab/clawcode/tree/main/.claw/design/UI/runwayml/DESIGN.md) to use as a reference for AI agents (Claude, Cursor, Stitch) to generate UI that looks like the RunwayML design language.
