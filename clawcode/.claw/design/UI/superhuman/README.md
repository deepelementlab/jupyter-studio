...
Use [DESIGN.md](https://github.com/deepelementlab/clawcode/tree/main/.claw/design/UI/superhuman/DESIGN.md) to use as a reference for AI agents (Claude, Cursor, Stitch) to generate UI that looks like the Superhuman design language.
